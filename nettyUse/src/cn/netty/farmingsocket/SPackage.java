...
public class SPackage {
	...
	public SPackage(byte[] bytes){
		...
		if(bytes.length>=26){
			...
			this.serialNo=String.format("%02x-%02x-%02x-%02x",bytes[6],bytes[7],bytes[8],bytes[9]);
	...
	public String toString() {
		return "SPackage [frameHeader=" + frameHeader + ", productinfo=" + productinfo + ", version=" + version
				+ ", deviceType=" + deviceType + ", type=" + type + ", deviceAddress=" + deviceAddress + ", serialNo="
				+ serialNo + ", cmdSerialNumber=" + Arrays.toString(cmdSerialNumber) + ", cmdword=" + cmdword
